...
\begin{enumerate}
    ...
    %\item \textbf{Word Transformer}: To replace the word with synonym, they have utilized novel word embeddings proposed by  Mrksè?ic í? et$.$ al$.$ \cite{mrksic_counter-fitting_2016}
