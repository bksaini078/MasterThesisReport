...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{img/NumQueriesDist_box_IMDB.png}
...
\begin{figure}[H]
    \centering
    %    \hspace*{2.5em}
    \includegraphics[width=1.0\linewidth]{img/attack_success_rate.png}
    \caption[Bar plot of attack success rate]{Bar plot of attack success rate}
...
\begin{figure}[H]
    \centering
    %    \hspace*{2.5em}
    \includegraphics[width=0.9\linewidth]{img/IMDB_class_attack.png}
    \caption[Bar plot of successful attack on different class labels for IMDB dataset]{Bar plot of successful attack on different class labels for IMDB dataset}
    \label{fig:classattack_imdb}
\end{figure}
\begin{figure}[H]
    \centering
    %    \hspace*{2.5em}
    \includegraphics[width=.9\linewidth]{img/fakenews_class_attack.png}
    \caption[Bar plot of successful attack on different class labels for Covid-19 fake tweets dataset]{Bar plot of successful attack on different class labels for Covid-19 fake tweets dataset}
